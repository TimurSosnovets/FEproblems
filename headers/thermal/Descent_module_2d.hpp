...
const double Lamda_GC = 50.8, Lambda_TZMK = 50.8, Lambda_AMg = 50.8;
...
class DM_FEmodel
{
    private:
        ...
        void elements_creation(const int N_cr, const int N_cn1, const int N_cn2, const int N_cl, const int N_gc, const int N_tzmk);
    public:
