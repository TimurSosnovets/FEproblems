...
Plate_triangulated::Plate_triangulated(const double lenX, const double lenY, const unsigned int m, const unsigned int n, const double thick, const Isotropic mater):
...
std::vector<std::pair<TriangleFE, unsigned int>> Plate_triangulated::FEs() const {
    return _finite_els;
}

std::vector<std::pair<Point, unsigned int>> Plate_triangulated::NDs() const {
    return _nodes;
}
